...
<body>
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="background-color: #97BD8A;">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="#" style="flex: 1; display: flex; align-items: center;">
                <img src="Logo_PTPN4.png" alt="PTPN 4 Logo" style="max-height: 50px; max-width: 150px; margin: 0 auto;">
            </a>
